...
public class login_Listener implements HttpSessionListener,ServletContextListener {
    ...
    public void sessionCreated(HttpSessionEvent hse) {
        ...
        int aa = (int)application.getAttribute("aa");
        application.setAttribute("Count", ++Count);
        application.setAttribute("aa", ++aa);
        System.out.println("当前在线用户数为："+application.getAttribute("Count"));
        System.out.println("当前不在线用户数为："+application.getAttribute("aa"));
    }

...
@WebServlet("/Release_Land_search")
public class Leased_Land_Search_Servlet extends HttpServlet {
    //        // TODO Auto-generated constructor stub
    @Override
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        List<Leased_land> list = new ArrayList<>(); //用于存储数据，类写在javabean里面，记得改一下
        List<Leased_land> list1 = new ArrayList<>();
        ...
        try {
            ...
            //4- SQL语句
            String SQL = "SELECT Order_Number FROM Leased_Land"; // 进行数据库操作
            //5-执行SQL,返回数据

 ...
 */
@WebServlet("/selectCustomerLand")
public class selectCustomerLand_servlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        request.getRequestDispatcher("/User_Home_Page/pages/user.jsp ").forward(request, response);//返回管理员首页

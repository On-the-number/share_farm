...
public class Registration_User_Servlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            //4- SQL语句
            String SQL = "select Farmer_Id,Password FROM Farmer"; // 进行数据库操作
            //5-执行SQL,返回数据
            ...
            request.getRequestDispatcher("/Registration/pages/Modal_as_Page/Modal_as_Page.jsp").forward(request, response);

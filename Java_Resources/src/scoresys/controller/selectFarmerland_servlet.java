 ...
 */
@WebServlet("/selectFarmerland")
public class selectFarmerland_servlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        request.getRequestDispatcher("/Home/pages/shouye.jsp ").forward(request, response);//返回首页

...
@WebServlet("/Login_Change")
public class Login_ChangeUser_Servlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("/Login/pages/LogIn/LogIn.jsp").forward(request, response);

 ...
 */
@WebServlet("/selectFarmerInfo")
//上面的是jsp界面form表单所抵达的地址
//查看已出租土地ID和其租用者的信息
public class selectFarmerInfo_Servlet extends HttpServlet {
  //        // TODO Auto-generated constructor stub
  @Override
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      List<Farmer> list = new ArrayList<Farmer>(); //用于存储数据，类写在javabean里面，记得改一下
      List<Farmer> list1 = new ArrayList<Farmer>(); //
      List<Farmer> list2 = new ArrayList<Farmer>(); //
      ...
      try {
        ...
        while (rs.next()) {
          ...
          System.out.println(rs.getString(1) +"," + rs.getString(3)+"," + rs.getString(4)+"," + rs.getString(6));//用户名 姓名 邮箱 电话号码
          list.add(temp);
          //一行多少个值，下标就可以取到多少.
        }
        while (rs.next()) {

 ...
 */
@WebServlet("/selectMessInfo")
//上面的是jsp界面form表单所抵达的地址
//查看留言信息 留言编号  留言内容
public class selectMessInfo_servlet extends HttpServlet {
  //        // TODO Auto-generated constructor stub
  @Override
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    List<Message> list = new ArrayList<Message>(); //用于存储数据，类写在javabean里面，记得改一下
    ...
    try {
      ...
      while (rs.next()) {
        ...
        System.out.println(rs.getString(1) + "," + rs.getString(2));//查看留言信息 留言编号  留言内容
        list.add(temp);
        //一行多少个值，下标就可以取到多少.
      }

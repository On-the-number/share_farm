  ...
  public List getall() {
    ...
    try {
      ...
      while (rs.next()) {
        ...
        temp.setFarmer_Id(rs.getString(1));
        temp.setFarmer_mail(rs.getString(2));
        temp.setFarmer_Name(rs.getString(3));
        temp.setPassword(rs.getString(4));
        temp.setFarmer_Sex(rs.getString(5));
        temp.setFarmer_Phone(rs.getString(6));
        temp.setStatus(Integer.parseInt(rs.getString(7)));
        list.add(temp);
        //一行多少个值，下标就可以取到多少.
      }
